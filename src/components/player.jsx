...
class RootPlayer extends Component {
    ...
    audioSeek(left, width) { //跳转 left:左位移， width：宽度
        return e => {
        ...
        return (
            <div>
                <div className={max?"hidden":"player"}>
                    ...
                    <div className="ant-progress-line" onClick={this.bindFuncs.audioSeek(0, 1).bind(this)} >
                        <div style={{width: this.state.progress}} className="progress-active"></div>
                        <div className="progress-background"></div>
                    </div>
                    <span className="time">
                    ...
                    <audio id="audio" preload="auto" onError={this.bindFuncs.next.bind(this, 1)} onTimeUpdate={this.bindFuncs.getProgress.bind(this)} ref="audio" src={song? song.url:""}></audio>
                </div>
                {this.getMaxPlayer()}
            </div>
        )
